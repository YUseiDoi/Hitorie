...
ActiveRecord::Schema.define(version: 2020_11_21_053605) do

  create_table "add_image_to_users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "image"
